    ...
    private MainWindow()
    {
        ...
        buttonGenerate.addActionListener((ActionEvent event) ->
        {
            ...
            try
            {
                ...
                params.gaussianBlurRadius = IOUtility.tryParseDouble(fieldGaussianBlurRadius.getText());
                ...
                IOUtility.verifyValue(params.gaussianBlurRadius, 0.0, Double.POSITIVE_INFINITY);
            }
